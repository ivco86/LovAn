...
# Configuration
# Import PHOTOS_DIR from local shared module
try:
    from .shared import PHOTOS_DIR as SHARED_PHOTOS_DIR, DATA_DIR
except ImportError:
    try:
        from shared import PHOTOS_DIR as SHARED_PHOTOS_DIR, DATA_DIR
    except ImportError:
...
try:
    KEYFRAMES_DIR = os.getenv('KEYFRAMES_DIR', os.path.join(DATA_DIR, 'youtube_keyframes'))
    SUBTITLES_DIR = os.getenv('SUBTITLES_DIR', os.path.join(DATA_DIR, 'youtube_subtitles'))
except NameError:
